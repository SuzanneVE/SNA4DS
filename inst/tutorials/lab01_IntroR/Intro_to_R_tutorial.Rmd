...
description: "Week 1: Introductory tutorial about how to program in the R language"
output: 
  learnr::tutorial:
    fig_caption: no
    progressive: true
...
\if{html}{\figure{cat.png}{options: width=100 alt="Figure: cat.png"}}
...
pkg <- c("SNA4DSData", "igraph", "sna", "gradethis")
...
of numbers, but only while they are still smaller than 6. 
...
It's a little difficult, but I KNOW THAT YOU CAN DO IT!!!


```{r grade_code23, exercise = TRUE, echo = TRUE, exercise.setup = "try_something39"}
