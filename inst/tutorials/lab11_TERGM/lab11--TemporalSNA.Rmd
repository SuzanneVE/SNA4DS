...
Before we start our time travel, we need to make sure we 
have our belts on, have enough toilet paper with us, 
and our teeths brushed. 
...
You need to have installed R version 4.1.1 (or higher) and this tutorial is going to check it
...
You need to have a few packages installed to ensure safe travels. 
...
(note that this code has already pre-run for layout purposes in this tutorial)
...
(this will not work inside your tutorial, 
but should work when you work interactively from RStudio).
