...
Turn on the over, we are ready for some mouth watering bun to cook!
...
This looks like a pretty nice mode! Let's comment on this model's overall meaning. 
...
This text informs us that the results are estimated computing maximum
...
This model might take a few minutes. Be patient and read the output in the meanwhile so you see what happens with the algorithm!
